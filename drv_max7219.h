...
// デコードなし時(8bitデータ = DP,A,B,C,D,E,F,Gの順)
// ビット: 0x80=DP, 0x40=A, 0x20=B, 0x10=C, 0x08=D, 0x04=E, 0x02=F, 0x01=G
#define SEG_CHAR_0               0x7E // '0' = A,B,C,D,E,F
#define SEG_CHAR_1               0x30 // '1' = B,C
#define SEG_CHAR_2               0x6D // '2' = A,B,G,E,D
#define SEG_CHAR_3               0x79 // '3' = A,B,C,D,G
#define SEG_CHAR_4               0x33 // '4' = F,G,B,C
#define SEG_CHAR_5               0x5B // '5' = A,F,G,C,D
#define SEG_CHAR_6               0x5F // '6' = A,F,E,D,C,G
#define SEG_CHAR_7               0x70 // '7' = A,B,C
#define SEG_CHAR_8               0x7F // '8' = A,B,C,D,E,F,G
#define SEG_CHAR_9               0x7B // '9' = A,B,C,D,F,G
#define SEG_CHAR_A               0x77 // 'A' = A,B,C,E,F,G
#define SEG_CHAR_B               0x1F // 'b' = C,D,E,F,G
#define SEG_CHAR_C               0x4E // 'C' = A,F,E,D
#define SEG_CHAR_D               0x3D // 'd' = B,C,D,E,G
#define SEG_CHAR_E               0x4F // 'E' = A,F,E,D,G
#define SEG_CHAR_F               0x47 // 'F' = A,F,E,G
#define SEG_CHAR_H               0x37 // 'H' = B,C,E,F,G
#define SEG_CHAR_L               0x0E // 'L' = F,E,D
#define SEG_CHAR_P               0x67 // 'P' = A,B,E,F,G
#define SEG_CHAR_R               0x05 // 'r' = E,G
#define SEG_CHAR_S               0x5B // 'S' = 5 と同じ
#define SEG_CHAR_U               0x3E // 'U' = B,C,D,E,F
#define SEG_CHAR_Y               0x3B // 'Y' = B,C,D,F,G
